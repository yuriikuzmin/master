...
import static com.kuzmin.master.R.string.your_order_failed;
...
public class YourOrder extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        et_your_number = (TextView) findViewById(R.id.et_your_master);
        ...
        et_your_number.setText(idMaster);
    ...
    public void onClickYourView(View view) {
        ...
        Log.d("LOG", "Проверяем idMaster from YourOrder=" + idMaster);
        new ViewYourOrder(YourOrder.this, tv_your_order).execute(master);
    }
    ...
    public class ViewYourOrder extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String data) {
            ...
            String temp = "У вас забронированных заказов нет";
            if(!temp.equals(data.toString())) {
                ...
                et_your_number.setText(data.toString());
            }
        }
